...
{
    // Цей клас реалізує INotifyPropertyChanged
    // для підтримки one-way та two-way прив’язки
    // (наприклад, для оновлення елемента інтерфейсу, 
    // при динамічній зміні джерела)
